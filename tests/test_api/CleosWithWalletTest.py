...
class CleosWithWalletTest(WalletTestCase):
    ...
    def test_10_unstakeTokens(self):
        ...
        getAliceAccountOutput = self.cleos.exec("get", "account", "alice")
        self.verifier.verifyAccountLiquidBalance(getAliceAccountOutput, "700.0000 CYBER")
        self.verifier.verifyAccountStakeBalance(getAliceAccountOutput, "300.0000 CYBER")
        self.verifier.verifyAccountUnstakingBalance(getAliceAccountOutput, "0.0000 CYBER")
        self.verifier.verifyAccountOwnedBalance(getAliceAccountOutput, "200.0000 CYBER")
        self.verifier.verifyAccountEffectiveBalance(getAliceAccountOutput, "280.0000 CYBER")
        self.verifier.verifyAccountTotalBalance(getAliceAccountOutput, "980.0000 CYBER")

    def test_11_stakeUsage(self):
        self.verifier.verifyStakeEnabled(self.cleos.exec("push", "action", "cyber.stake", "enable", "[\"4,CYBER\"]", "-p", "cyber"))
        ...
        self.verifier.verifyResoursesStakeEndowment(output)
        self.verifier.verifyResoursesStakeUsage(output)
