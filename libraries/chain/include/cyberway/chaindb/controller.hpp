...
namespace cyberway { namespace chaindb {
    ...
    public:
        ...
        bool has_cache_converter(const table_request&) const;
        ...
        void insert(const table_name& table, const account_name& code, object_value obj, storage_payer_info) const;
