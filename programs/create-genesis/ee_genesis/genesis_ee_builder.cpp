...
#define AUTHOR_REWARD_HISTORY_DAYS    1
#define CURATOR_REWARD_HISTORY_DAYS   1
#define DELEGATOR_REWARD_HISTORY_DAYS 1
...
void genesis_ee_builder::write_rewards_history() {
    ...
    if (dump_author_rewards.is_open()) {
        ...
        auto start_time = genesis_.get_conf().initial_timestamp;
        start_time -= fc::days(AUTHOR_REWARD_HISTORY_DAYS);
    ...
    if (dump_curation_rewards.is_open()) {
        ...
        auto start_time = genesis_.get_conf().initial_timestamp;
        start_time -= fc::days(CURATOR_REWARD_HISTORY_DAYS);
    ...
    if (dump_delegation_rewards.is_open()) {
        ...
        auto start_time = genesis_.get_conf().initial_timestamp;
        start_time -= fc::days(DELEGATOR_REWARD_HISTORY_DAYS);
